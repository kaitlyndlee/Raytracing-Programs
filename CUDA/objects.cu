 ...
 */
void add_new_sphere(shape_t *shape_list, unsigned int num_shapes, float *diffuse, float *specular, 
                        float *position, float radius, float reflectivity, float refractivity, float ior) {
 ...
 * @param reflectivity - variable reflectivity to set the reflectiveness of the object
 */
void add_new_plane(shape_t *shape_list, unsigned int num_shapes, float *diffuse, float *specular, 
                       float *position, float *normal, float reflectivity) {
 ...
 * @param reflectivity - variable reflectivity to set the reflectiveness of the object
 */
void add_new_quadric(shape_t *shape_list, unsigned int num_shapes, float *diffuse, float *specular, 
 ...
 */
void add_new_point_light(light_t *light_list, unsigned int num_lights, float *color, 
                             float *position, float *radial_coef) {
  for (int i = 0; i < 3; i++) {
 ...
 * @param radial_coef - a v3 vector representing the radial coefficent of the light
 */
void add_new_spot_light(light_t *light_list, unsigned int num_lights, float *color, float *position, 
