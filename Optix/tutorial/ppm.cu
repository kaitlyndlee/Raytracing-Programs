...
/**
 * Checks to see if the file is at its end. If it is at the end the function, will call ppm_Fail
...
void ppm_ReadInP3(FILE *inFile, PPMFormat inData) {
  ...
  for (int y = 0; y < inData.height; y++) {
    for (int x = 0; x < inData.width; x++) {
      for (int p = 0; p < 3; p++) {
        ppm_AtEndOfFile(
            inFile, (char *) "The input file is too short based on the given height and width.");
...
void ppm_ReadInP6(FILE *inFile, PPMFormat inData) {
  ...
  for (int y = 0; y < inData.height; y++) {
    for (int x = 0; x < inData.width; x++) {
      ...
      if (entriesRead < 1) {
        ppm_Fail((char *) "The input file is too short based on the given height and width.");
      }
...
/**
 * Prints the pixmap from the PPMFormat data structure into the output file. This fucntion will
 * print in P3 PPM format, so it will print out in ASCII.
 *
 * @param inData The data structure holding the pixmap and PPM values
...
/**
 * Prints the pixmap from the PPMFormat data structure into the output file. This fucntion will
 * print in P6 PPM format, so it will print out in raw binary.
 *
 * @param inData The data structure holding the pixmap and PPM values
 * @param outFile The output file
 */
...
/**
 * Prints the pixmap from the PPMFormat data structure into the output file. This fucntion will
 * print in P7 PPM format, so it will print out in raw binary.
 *
 * @param inData The data structure holding the pixmap and PPM values
 * @param outFile The output file
 */
